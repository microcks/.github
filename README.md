...
The canonical [project and repository inventory](SUBPROJECTS.md) records the purpose, lifecycle status and responsible ownership of Microcks' public first-party repositories.
